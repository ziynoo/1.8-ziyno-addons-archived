...
public class DungeonHighlight {
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        ...
        for (Entity entity : mc.theWorld.loadedEntityList) {
            ...
            boolean isAssassin = isAssassinRaw && shadowAssassinEnabled; 
            ...
            float r = 1f, g = 0f, b = 1f; 
            if (isFrozen) { r = 0.4f; g = 0.8f; b = 1.0f; }        
            if (isLost) { r = 0.0f; g = 0.9f; b = 0.6f; }          
            if (isArchaeologist) { r = 0.0f; g = 0.7f; b = 1.0f; } 
            if (isMidas) { r = 1.0f; g = 0.84f; b = 0.0f; }        
