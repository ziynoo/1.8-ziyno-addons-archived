...
public class ChatCountdownNecron extends Gui {
    ...
    private static final int TOTAL_TICKS = (int) Math.ceil(7.8 * 20.0); // 156
    ...
    public void onChat(ClientChatReceivedEvent event) {
        ...
        // Trigger countdown for the specific boss message
    ...
    public void onRenderOverlay(RenderGameOverlayEvent.Text event) {
        ...
        float y = (screenHeight / 2f - 65) / scale; // slightly above crosshair
            ...
            nm.channel().pipeline().addBefore("packet_handler", PIPELINE_NAME, new ChannelDuplexHandler() {
                ...
                public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
                    ...
                    if (msg instanceof S03PacketTimeUpdate) {
                        if (s03Active) {
                            // we *could* align to world time here if we wanted
                        }
                    }
